...
public class MainActivity1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        rb1 = findViewById(R.id.ratingBar2); //fatigue
        rb2 = findViewById(R.id.ratingBar3);//mood
        rb3 = findViewById(R.id.ratingBar4);//soreness
        rb4 = findViewById(R.id.ratingBar5);//stress


        predict = findViewById(R.id.buttonSendToNextPage);
...
//        float stress = (Float) rb4.getRating();
        ...
        Log.i("soreness", String.valueOf(soreness));
        Log.i("step count", String.valueOf(step_count));
        ...
        predict.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                float physical_score = doInference_physical(String.valueOf(distance), String.valueOf(calorie), String.valueOf(step_count), String.valueOf(soreness));
                float sentiment_score = doInference_sentiment(String.valueOf(fatigue), String.valueOf(mood), String.valueOf(stress));
    ...
    public float doInference_sentiment(String val, String val2, String val3)
    {
    ...
    public float doInference_sleepscore(String val, String val2, String val3, String val4, String val5, String val6, String val7, String val8, String val9, String val10, String val11)
    {
